...
- English and Simplified Chinese web UI with a language preference switch
- Optional custom keys such as `server.com/pasta/my-note`

The web UI uses the browser's language on first visit and remembers a manual
choice in the `microbin_lang` cookie. When creating a pasta, enter a custom key
using 3-64 lowercase letters, numbers, hyphens, or underscores, or leave it
blank to keep the generated key.
